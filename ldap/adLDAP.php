...
class adLDAP {
    ...
    * @var string
    */   
	protected $accountSuffix = "@sccorinthians.com.br";
    ...
    * @var string
    */
	protected $baseDn = "DC=sccorinthians,DC=com,DC=br"; 
    ...
    * @var array
    */
    protected $domainControllers = array("sccp15.sccorinthians.com.br","sccp17.sccorinthians.com.br");
    ...
    * @var string
    */
	protected $adminUsername = 'lfsilva';
    protected $adminPassword = 'luiz21lv4';
